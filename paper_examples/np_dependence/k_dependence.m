%
% This code tests the number of proxy points needed
% to achieve the desired precision as a function of the wavenumber
...
nzk = 3;
npxy_pts = 8;
errs = zeros(nzk, npxy_pts);
npxys_all = zeros(nzk, npxy_pts);
for ii=1:nzk
...
legend([ss '$k =2\pi$'], [ss '$k = 4\pi$'], [ss '$k = 8\pi$'], 'interpreter', 'latex')
