%
%  Number of proxy points as a function of distance between ellipses.
%
clear
clc
...
ndsep = 3;
npxy_pts = 8;
errs = zeros(ndsep, npxy_pts);
npxys_all = zeros(ndsep, npxy_pts);
dseps = [0.5, 0.75, 1.0];
...
legend([ss '$d = 1/2$'], [ss '$d = 3/4$'], [ss '$d = 1$'], 'interpreter', 'latex','Location','SouthWest')
